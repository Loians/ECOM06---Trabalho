Para Windows, utilizou-se da ferramenta GIT SDK para fazer a compilação e execução dos arquivos, caso precise baixá-la o link é: https://github.com/git-for-windows/build-extra/releases/tag/git-sdk-1.0.8
